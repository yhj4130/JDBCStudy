	...
	public static void main(String[] args)
	{
		...
		do
		{
			...
			try
			{
				...
				{
					case 1:
						prc.sungjukInsert();		// 성적 입력 기능 메소드
						break;
					case 2:
						prc.sungjukSelectAll();		// 성적 전체 출력 기능 메소드
						break;
					case 3:	
						prc.sungjukSearchName();	// 이름 검색 출력 기능 메소드
						break;
					case 4:
						prc.sungjukUpdate();		// 성적 수정 기능 메소드
						break;
					case 5:
						prc.sungjukDelete();		// 성적 삭제 기능 메소드
						break;
				}
